					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group form-group-default">
								<label>Cedula</label>
								<input name="dnipa" type="text" required class="form-control" maxlength="12" placeholder="Ingrese su numero de cedula" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
							</div>
						</div>
				...
				<option value="No">No</option>
						...
						<div class="col-md-6">
							<div class="form-group form-group-default">
								...
								<input name="tele" type="text" class="form-control" required maxlength="15" placeholder="Ingrese teléfono" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
							</div>
						</div>
